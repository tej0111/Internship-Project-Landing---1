...
const LandingPageView2 = () => {
  ...
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(225deg, rgba(77,61,46,1) 23%, rgba(182,133,217,1) 62%, rgba(185,180,183,1) 84%)'
      }}
    >
      {/* Navbar Section */}
    ...
    <div className="flex flex-col gap-4">
      ...
      <button
        key={link.musicPlatform + link.url}
            className="flex items-center p-2 border border-gray-700 rounded-full shadow-md hover:bg-gray-700 transition"
        ...
        <ScrollArea>
          ...
          <div id="performances" className="mt-8">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <h2 className="text-3xl font-bold text-center text-slate-800 mb-6">Performances</h2>
          ...
          <div id="songsSale">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <h2 className="text-3xl font-bold text-center text-slate-800 mb-6">Songs for Sale</h2>
          ...
          <div id="merchandise">
            <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
              <h2 className="text-3xl font-bold text-center text-slate-800 mb-6">Merchandise</h2>
          ...
          <div id="messages">
            {fanMessages && (
              <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                <h2 className="text-3xl font-bold text-center text-slate-800 mb-6">Fan Messages</h2>
          ...
          <div id="support">
            {supportPage && (
              <div className="p-6 max-w-3xl mx-auto bg-white bg-opacity-30 backdrop-blur-lg rounded-lg shadow-lg mb-8">
                <h2 className="text-3xl font-bold text-center text-slate-800 mb-6">Support Me</h2>
